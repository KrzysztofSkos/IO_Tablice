...
# Stałe do sprawdzania czy znak jest możliwy
MIN_PIXEL_WIDTH = 2
MIN_PIXEL_HEIGHT = 8
...
def loadKNNDataAndTrainKNN():
    ...
    # Wczytanie treningu klasyfikacji
    try:
...
def detectCharsInPlates(listOfPossiblePlates):
    ...
    for possiblePlate in listOfPossiblePlates:
        ...
        # Znalezienie wszystkich możliwych znaków na tablicy i ich zgrupowań
        ...
        # Znalezienie najdłuższej listy znaków na tablicy
        ...
        # Przekazanei najdłuższego ciągu do rozpoznawania znaków
...
def checkIfPossibleChar(possibleChar):
    # Pierwsza selekcjia - czy kontur może być znakiem
...
def findListOfListsOfMatchingChars(listOfPossibleChars):
    # Przeformatowanie dużej listy znaków na mniejsze
    ...
    for possibleChar in listOfPossibleChars:
        ...
        # Jeżeli lista jest zbyt krótka - ignorujemy ją
        if len(listOfMatchingChars) < MIN_NUMBER_OF_MATCHING_CHARS:
            continue

        listOfListsOfMatchingChars.append(listOfMatchingChars)
        listOfPossibleCharsWithCurrentMatchesRemoved = []
        # Usunięcie powtarzających się znaków z dużej listy
...
def findListOfMatchingChars(possibleChar, listOfChars):
    # Sprawedzenie podobieństwa znaku do znaków w liście
    listOfMatchingChars = []
