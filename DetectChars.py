...
def detectCharsInPlates(listOfPossiblePlates):
    ...
    for possiblePlate in listOfPossiblePlates:  # for each possible plate, this is a big for loop that takes up most of the function
        ...
        # possiblePlate.strChars = pytesseract.image_to_string(possiblePlate.imgThresh, config='--psm 11')
...
def recognizeCharsInPlate(imgThresh, listOfMatchingChars):
    ...
    # tesseractChar = pytesseract.image_to_string(imgThresh, config='--psm 11')
    # print("Tesseract", tesseractChar)
    # return tesseractChar
    ...
    for currentChar in listOfMatchingChars:  # for each char in plate
        ...
        # temp = pytesseract.image_to_string(imgROIResized, config='--psm 11')
        strCurrentChar = str(chr(int(npaResults[0][0])))  # get character from results
        # tesseractChar = tesseractChar + temp
